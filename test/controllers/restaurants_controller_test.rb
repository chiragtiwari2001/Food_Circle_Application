...
class RestaurantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should redriect create when not logged in' do
    ...
    assert_no_difference 'Restaurant.count' do
      post restaurants_path, params: { restaurant: { restaurant_name: 'example',
        ...
        restaurant_image: 'assets/background.webp', status: 'open', restaurant_details: 'a place to eat', restaurant_image: image_file } }
    end
  ...
  test 'should redriect create when logged in as member' do
    ...
    assert_no_difference 'Restaurant.count' do
      post restaurants_path, params: { restaurant: { restaurant_name: 'example',
        ...
        restaurant_details: 'a place to eat', restaurant_image: image_file } }
    end
  ...
  test 'should redirect update when logged in as member' do
    sign_in users(:michael)
    patch restaurant_path(@outlet), params: { restaurant: {
      restaurant_name: 'K3', restaurant_email: 'k3@gmail.com' } }
    assert_not flash.empty?
    assert_redirected_to root_url
  end
