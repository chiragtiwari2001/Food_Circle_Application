...
class RestaurantTest < ActiveSupport::TestCase
  def setup
    @outlet = Restaurant.new(restaurant_name: "example outlet", restaurant_email: "user@example.com", restaurant_details: "this is a details for example outlet", restaurant_address: "44-b example colony", restaurant_contact: 1234567890, status: "")
  end
